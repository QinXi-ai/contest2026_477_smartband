...
LOGS = PACK3 / "logs"
NEW_IMAGE = PACK3 / (
    "output/Gemini-S1-MoonCat-AI-QuickApp-autostart-no-launcher-"
...
NEW_DUMP = PACK3 / (
    ...
    "20260829-candidate-03.img.dump"
)
OLD_DUMP = PACK2 / (
    "audit/candidate/"
...
BUILD_ROOT = Path("/data/openvela-contest-2026-gemini-s1-v1-build-20260829-03")
...
GENERATED_RCS = BUILD_ROOT / "nuttx/arch/arm/src/board/etctmp/etc/init.d/rcS"
...
def main() -> None:
    ...
    old_diffs, old_size, old_hash = compare_payloads(
        items, "white-screen-candidate", OLD_DUMP, OLD_IMAGE
    )
    ...
    summary = [
        ...
        f"white_screen_candidate_path={OLD_IMAGE}",
        f"white_screen_candidate_bytes={old_size}",
        f"white_screen_candidate_sha256={old_hash}",
        f"candidate_minus_white_screen_bytes={image_size - old_size}",
        ...
        f"diff_vs_white_screen={' '.join(old_diffs)}",
